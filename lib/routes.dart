...
class Routes{
  static Map<String, Widget Function(BuildContext context)> routes = {
    ...
    SearchFunctionaryScreen.routName : (context) => SearchFunctionaryScreen(),
    FormCashScreen.routName : (context) => FormCashScreen(),
    SearchCashScreen.routName : (context) => SearchCashScreen(),
    LoginScreen.routName : (context) => LoginScreen(),
    FormBenefitsScreen.routName : (context) => FormBenefitsScreen(),
    SearchBenefitsScreen.routName : (context) => SearchBenefitsScreen(),
    ...
    SearchAvaliationScreen.routName : (context) => SearchAvaliationScreen(),
  };
}