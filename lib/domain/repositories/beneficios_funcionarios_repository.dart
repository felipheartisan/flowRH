...
''');
    ...
    List<BeneficiosFuncionarios> beneficios_funcionariosResults = [];
    ...
    if (result.isNotEmpty){
        for (int i = 0; i < result.length; i++){            
            ...
            BeneficiosFuncionarios beneficios_funcionarios = BeneficiosFuncionarios.fromMap(item);
            beneficios_funcionariosResults.add(beneficios_funcionarios);
        }
    }
     
    return beneficios_funcionariosResults;
  }  
